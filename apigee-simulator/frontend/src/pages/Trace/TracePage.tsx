...
export default function TracePage() {
  ...
  async function runTrace() {
    ...
    try {
      ...
      // Query params can be typed straight into Path (e.g. "/secure?access_token=abc123") -
      // split them out here so policies that read query params (like OAuthV2 VerifyAccessToken
      // configured for "Query Parameter" token location) actually see them.
